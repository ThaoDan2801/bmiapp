...
public class SegmentView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        // Load attributes
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SegmentView, defStyle, 0);

        backgroundDrawable.setColor(a.getColor(R.styleable.SegmentView_unselectedBackgroundColor, Color.parseColor("#F7F7F9")));
        unselectedTextColor = a.getColor(R.styleable.SegmentView_unselectedTextColor, Color.parseColor("#ACADB1"));
        selectedTextColor = a.getColor(R.styleable.SegmentView_selectedSegmentTextColor, getContext().getColor(R.color.black));
    ...
    private void setupBackground() {
        ...
        backgroundDrawable.setCornerRadius(dpToPx(19));
        backgroundDrawable.setStroke(0, Color.parseColor("#F7F7F9"));
    ...
    private View createLine() {
        ...
        LayoutParams lineLayout = new LayoutParams(dpToPx(1), ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    private Drawable createSelectedItemBackground() {
        ...
        drawable.setCornerRadius(dpToPx(19));
        return drawable;
    }
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (view instanceof TextView) {
                ...
                if (index < items.size()) {
                    ...
                    if (icons.size() > 0) {
                        int drawableId = icons.get(index);
    ...
    public void setIcon(int index, int drawableId) {
        if (index >= 0) {
            if (index < icons.size()) {
                icons.remove(index);
                icons.add(index, drawableId);
            } else {
    ...
    public void setEnabled(boolean enabled) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            if (getChildAt(i) instanceof TextView) updateEnableState((TextView) getChildAt(i));
        }
    }
